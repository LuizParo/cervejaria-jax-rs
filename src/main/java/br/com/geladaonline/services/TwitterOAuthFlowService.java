...
public class TwitterOAuthFlowService {
    ...
    private static final String CONSUMER_KEY = "wcG7XdEQyrUK2wEOfUOgNMUFa";
    private static final String CONSUMER_SECRET = "NR8nwTeYHLZrOFbVijbH14G10mhfAU7VyDrki6Plc1R7UnPKrK";
